...
class Batch(object):
    def _pad(self, data, pad_id, width=-1):
        ...
        :param pad_id: id for [PAD]
        :param width: width of final matrix
        :return: padded matrix of data
        """
        if width == -1:
    ...
    def __init__(self, data=None, device=None,  is_test=False):
        ...
        if data is not None:
            ...
            # If test, include src_str, tgt_str.
            if is_test:
...
class Dataloader(object):
    ...
    def _next_dataset_iterator(self, dataset_iter):
        try:
            # Drop the current dataset to save memory.
...
class DataIterator(object):
    def __init__(self, args, dataset,  batch_size,  device=None,
        ...
        self.iterations = 0
        self.device = device
        self.shuffle, self.is_test = shuffle, is_test
